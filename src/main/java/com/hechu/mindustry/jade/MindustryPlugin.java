...
public class MindustryPlugin implements IWailaPlugin {
    ...
    public static final ResourceLocation Drill = new ResourceLocation(MindustryConstants.MOD_ID, "drill");
    public static final ResourceLocation HealthBlock = new ResourceLocation(MindustryConstants.MOD_ID, "health_block");
    public static final ResourceLocation CraftingBlock = new ResourceLocation(MindustryConstants.MOD_ID, "crafting_block");
